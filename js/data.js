...
window.SITE = {
  ...
  contacts: {
    ru: [
      ...
      { label: "FL.ru", href: null, hint: "профиль — гейт", gate: true },
      { label: "Профи", href: null, hint: "профиль — гейт", gate: true },
    ],
    en: [
      { label: "Telegram", href: "https://t.me/valdk_corp", hint: "@valdk_corp" },
      { label: "GitHub", href: "https://github.com/ValDagon", hint: "ValDagon" },
      { label: "LinkedIn", href: "https://www.linkedin.com/in/valkz", hint: "valkz" },
      { label: "Upwork", href: null, hint: "profile URL — gate", gate: true },
      { label: "Studio email", href: null, hint: "Sensual Studio DOO — gate", gate: true },
    ],
    sr: [
      { label: "Telegram", href: "https://t.me/valdk_corp", hint: "@valdk_corp" },
      { label: "GitHub", href: "https://github.com/ValDagon", hint: "ValDagon" },
      { label: "LinkedIn", href: "https://www.linkedin.com/in/valkz", hint: "valkz" },
      { label: "Upwork", href: null, hint: "URL profila — gejt", gate: true },
      { label: "Email studija", href: null, hint: "Sensual Studio DOO — gejt", gate: true },
    ],
  },

  legal: {
    ru: "Заказы на территории РФ выполняю как самозанятый. Биржи: Kwork, FL.ru, Профи.",
